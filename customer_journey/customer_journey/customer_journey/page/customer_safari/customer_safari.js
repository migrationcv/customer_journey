...
//Rendering the html page
                         ...
                         var rpm2_days = null_check(creation_data["RPM2_diff"])
                         var rpm2_creation = null_check(creation_data["RPM2_creation"])

                         var product_sell_days = null_check(null)
                         var product_sell_creation = null_check(null)
                         var renewal_days = null_check(null)
                         var renewal_creation = null_check(creation_data["Renewal_creation"])
                         ...
                         var element_list = ["Lead" ,"RPM" ,"Opportunity" ,"KYC" , "Customer" ,"Payment Entry" ,"Sales Invoice" ,"SVP" ,"Upgrade", "RPM2", "Product Sold", "Renewal", "Service Expired"]
